    ...
    <div className='container mx-auto h-full'>
      ...
      -space-x-48 lg:-space-x-24'>
        <div className='text-white flex-1 z-10 pl-6 lg:pl-0'>
          ...
          <button className='btn btn-sm lg:btn-lg btn-secondary' data-aos='fade-down' data-aos-delay='750'>{textBtn}</button>
        </div>
        <div className='bg-blue-300 w-full h-full bg-banner bg-cover bg-right 
