  ...
  max-w-[1280px] mx-auto gap-y-4'>
    ...
    {plans.map((plan , currentIndex)=> {
      ...
      className='w-full md:max-w-[620px] lg:max-w-[405px] rounded-sm 
       px-4 lg:min-h-[550px]' key={currentIndex} 
       ...
       >
        ...
        <div className={`${currentIndex === index 
          ...
          : 'bg-neutral-400/10 text-neutral-500' } flex justify-center items-center
          ...
          gap-y-8 lg:gap-x-0 items-center'>
                ...
                <div>
                  ...
                  ? 'bg-white text-neutral-500' : 'bg-neutral-500 text-white'}
                  h-[26px] font-primary text-sm font-semibold min-w-min
                  mx-auto px-[14px] flex items-center justify-center mb-8`}>{name}</div>
                  {/* { price } */}
                  <div className='text-[40px] lg:text-[50px]
                      font-primary font-extrabold text-center flex 
                  ...
                  <ul className='flex flex-col gap-y-4 mb-8'>
                    {list.map((item , idx)=>{
                      return <li className='flex items-center gap-x-[10px]' key={idx}>
                        <BsCheckCircleFill className='text-gl'/>
                        <div>{item.name}</div>
                        </li>
                    })}
                  </ul>
